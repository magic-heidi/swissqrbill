...
${this.formatAddress(this.data.creditor)}`, {
    ...
    if (this.data.amount !== void 0) {
      doc.text(utils.formatAmount(this.data.amount, this.data.amountLocale), this.x(amountXPosition), this.y(71), {
        lineGap: -0.5,
        width: utils.mm2pt(52 - amountXPosition)
      });
    } else {
    ...
    const swissQRCode = new swissqrcode.SwissQRCode(this.data, void 0, this.qrTheme);
    ...
    if (this.data.amount !== void 0) {
      doc.text(utils.formatAmount(this.data.amount, this.data.amountLocale), this.x(89), this.y(72), {
        lineGap: -0.5,
        width: utils.mm2pt(29)
      });
    } else {
